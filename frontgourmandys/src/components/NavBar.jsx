...
import {
    ...
    NavbarToggler,
    Nav,
    NavItem, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, NavbarText,
} from 'reactstrap';
    ...
    return (
        ...
        //     </div>
            <div className="border-top border-bottom border-black">
                <Navbar color="faded" className="d-flex flex-row mx-5" light>
                    <NavbarToggler className="me-auto border-0" />
                    <Nav navbar className="me-auto d-flex flex-row justify-content-around w-50">
                        <NavItem className="d-flex object-fit-cover align-items-center">
                            ...
                            <NavLink to="/#" className="text-decoration-none text-black fw-bold">PROMO</NavLink>
                        </NavItem>
                        <NavItem className="d-flex object-fit-cover align-items-center">
